/*
 * Space Invaders game
 * Original author: Dave Kerr - https://github.com/dwmkerr/spaceinvaders
...
//  Game font
var GAME_FONT = "'Nokia Cellphone FC'";

// Screen width
const gameScreenWidth = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;
...
GameOverState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font="16px " + GAME_FONT;
    ctx.fillText("Press 'Space' or tap to play again.", game.width / 2, game.height/2 + 40);   
};
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    for(var i=0; i<this.rockets.length; i++) {
        var rocket = this.rockets[i];
        ctx.fillRect(rocket.x, rocket.y - 2, 2, 10);
    }
    ...
    ctx.textAlign = "left";
    ctx.fillText(info, game.gameBounds.left + 10, textYpos);
    info = "Score: " + game.score + " | Level: " + game.level;
    ctx.textAlign = "right";
    ctx.fillText(info, game.gameBounds.right - 10, textYpos);
